# Lab-8 (IT 314)
# Name - Sojitra Kashyap Alpeshbhai
# ID - 202001217

## 1. Create a new Eclipse project, and within the project create a package and defining the class
...
### 6. Run all the test cases which is written in the code
...
```
This new test case checks that the lengthInInches() method returns the expected value when called on each of the Boa objects created in the setUp() method. It uses the assertEquals() method to compare the expected value to the actual value returned by the lengthInInches() method. 
